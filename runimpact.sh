...
python3 ../scripts/combineTool.py -M Impacts -d "$plotname".root -m 125 --doInitialFit --robustFit 1 --redefineSignalPOIs s2B2Q_4bin --preFitValue 0 --setParameters s2B2Q_4bin=0
python3 ../scripts/combineTool.py -M Impacts -d "$plotname".root -m 125 --robustFit 1 --doFits --redefineSignalPOIs s2B2Q_4bin --preFitValue 0 --setParameters s2B2Q_4bin=0
python3 ../scripts/combineTool.py -M Impacts -d "$plotname".root -m 125 -o impacts.json --redefineSignalPOIs s2B2Q_4bin --preFitValue 0 --setParameters s2B2Q_4bin=0
python3 ../scripts/plotImpacts.py -i impacts.json -o "$plotname"_impact
