...
## User configuration
VERBOSE  = True
IN_DIR   = '/afs/cern.ch/work/c/csutanta/public/rootfiles/unskimmed_EGamma_' #unskimmed_singlemuon_
CATS     = ['bdtVeto',
            'bdtLo',
            'bdtMed',
            'bdtHi']
...
OUT_DIR  = 'HtoAA_TTBarLep_AK8_tagger_calib/'
...
def main():
    ...
    for sel in SELS:
        out_file_str = OUT_DIR+'AK8_tagger_calib_%s_%s_%s_slc7.root' % (TAGNM[tag],sel, str(SVAR).replace('.','p'))
