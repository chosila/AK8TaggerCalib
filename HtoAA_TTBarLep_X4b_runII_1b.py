...
def main():
            ...
            for tag in TAGGERS.keys():
                ...
                for year in YEARS:
                    ...
                    for era in ERAS:
                        ...
                        mod_cat = 'sideband'
                        h_out_name = DATA+'_runII_'+mod_cat+'_'+TAGNM[tag]
    ...
    for sel in SELS:
        ...
        out_file_str = OUT_DIR+'AK8_tagger_calib_%s_1b_WP%s_%s_slc7.root' % (tag_str, args.WP, str(SVAR).replace('.','p'))
